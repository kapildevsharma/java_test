...
public class Java8QuesAns {
	...
	public static void main(String[] args) {
        ...
        max = numbers.stream().sorted(Collections.reverseOrder()).findFirst().get();
        System.out.println("max value from list "+ max);
        ...
        // Write a Java 8 program to convert old to even integers then find average and print results.
        System.out.println("program to convert old to even integers then find average and print results");
        double avgVal =  numbers.stream().map( n -> n%2!=0 ? n++ : n).mapToInt(Integer::intValue).average().getAsDouble();
        //avgVal = numbers.stream().filter(n -> n % 2 == 0).mapToInt(n -> n).average().getAsDouble();
       ...
       //Write a Java 8 program to print the lengths of strings in a list.
        ...
        Iterator<Map.Entry<Integer, List<String>>> iter = groupByLenghtMap.entrySet().iterator();
        while(iter.hasNext()) {
        ...
        // Write a Java 8 program to find min and max value in list.
        System.out.println("program to max and min elements in a list, then print");
        max = numbers.stream().max(Comparator.naturalOrder()).get().intValue();
        int min = numbers.stream().min(Comparator.reverseOrder()).get().intValue();
        ...
        // Write a Java 8 program to find duplicate element in list.
        ...
        Map<Integer, Long> duplicateMap = IntStream.of( 1, 2, 3, 2, 1, 2, 3, 4, 2, 5, 2 ).boxed().
         ...
         List<Integer> duplicateList= duplicateMap.entrySet().stream().filter(p -> p.getValue()>1).map(Map.Entry::getKey).collect(Collectors.toList());
         duplicateList.forEach(System.out::println);
         
         // How to filter an array of strings by a given prefix using Java 8 Stream
         System.out.println("program to filter an array of strings by a given prefix using Java 8 Stream.");
        ...
        Character resultVar = str.chars()
              ...
              //  .orElse(null);
                .orElseGet(()->'\0');
        System.out.println("First non-repeating character: " + resultVar);
